...
<picture>
  ...
  <img 
    src="/static/img/posts/qwen35-medium-opensource-local/qwen35-medium-opensource-local-2.webp" 
...
이전에 다뤘던 [AI CAPEX 부담과 소프트웨어주 재평가](/economy/2026/02/25/anthropic-software-selloff.html)에서 보듯, 현재 빅테크들은 AI 인프라에 천문학적인 자본을 쏟아붓고 있습니다. 그 과정에서 이 비용을 감당하지 못하는 중소기업과 개인 개발자는 점점 소외되고 있었습니다. Qwen3.5-35B-A3B의 Apache 2.0 공개는 그 구도에 조용히 균열을 냅니다.
