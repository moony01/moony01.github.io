...
## KT 인터넷 속도 미달 SLA 위약금 자동 청구 가이드
...
<picture>
  ...
  <img 
    src="/static/img/posts/kt-sla-auto-claim/kt-sla-auto-claim-2.webp" 
...
이 도구처럼 반복 작업을 자동화하는 접근법은 AI 도구에서도 확인할 수 있다. [Claude Code Routines 자동화 가이드](/ai/2026/04/15/claude-code-routines.html)에서 GitHub 이벤트와 스케줄 기반 자동화 사례를 더 확인할 수 있다.
