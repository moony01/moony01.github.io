...
image: cloudflare-agent-deploy/cloudflare-agent-deploy-1.png
lang: en
published: true
---
...
![Cloudflare AI agents buying domains and deploying apps through a bright automated infrastructure pipeline](/static/img/posts/cloudflare-agent-deploy/cloudflare-agent-deploy-1.png){: .wd100}
...
![Agentic infrastructure drift visualized as bright cloud resources branching from prompts into domains tokens and deployments](/static/img/posts/cloudflare-agent-deploy/cloudflare-agent-deploy-2.png){: .wd100}
