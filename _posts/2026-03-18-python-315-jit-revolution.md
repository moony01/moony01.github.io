...
<picture>
  ...
  <img 
    src="/static/img/posts/python-315-jit-revolution/python-315-jit-revolution-1.webp" 
    alt="히어로 이미지" 
    class="wd100"
    loading="lazy"
    decoding="async">
...
<picture>
  <source 
    ...
    sizes="(max-width: 640px) 400px, (max-width: 1024px) 800px, 1200px">
  <img 
    src="/static/img/posts/python-315-jit-revolution/python-315-jit-revolution-2.webp" 
    alt="본문 이미지" 
    class="wd100"
    loading="lazy"
    decoding="async">
