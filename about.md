...
## **개발자 정보**
- **이름:** 한문희
- **이메일:** mun_1201@naver.com
- **생년월일:** 1991년 12월 1일
- **포지션:** 풀스택 개발자
- **기술 능력:** 
  - **프런트엔드 개발:** 사용자 경험을 중심으로 한 인터페이스 설계 및 구현
  - **백엔드 개발:** 서버 사이드 로직 및 데이터베이스 관리
...
- **상세 설명:** 
  - 남성 및 단체복 전문 쇼핑몰의 프런트엔드 개발과 유지보수를 담당하여 웹사이트의 기능 개선 및 사용자 경험을 향상시킴.
...
- **상세 설명:** 
  - 앱 퍼블리싱 개발 및 Python을 활용한 이미지 검색 크롤링으로 머신러닝 데이터 수집.
  - Teachable Machine을 이용한 이미지 학습과 반응형 웹 구현.
...
- **상세 설명:** 
  - SpringBoot 및 Nuxt 프로젝트 구축.
  - Frontend 및 backend 개발, 서버 프록싱.
  - 의존성 관리 및 설치, 시스템 설계도 작성.
